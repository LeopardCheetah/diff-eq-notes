...
\begin{exercise}{20}
    ...
    This problem is very tricky and I almost got it. Essentially, we set $y = nx$, correspondingly find $\frac{dy}{dx} = n + \frac{dn}{dx}x$, then plug that back into our equation and solve. 
