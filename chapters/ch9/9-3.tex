...
\begin{exercise}{\{5, 6, 7\}abc}
    ...
    $(2, -2) \rightarrow \begin{pmatrix}
        0 & -6 \\ 2 & 0 
    \end{pmatrix} \rightarrow \lambda = \pm i\sqrt{12}$ so $(2, -2)$ has indeterminate stability and is either a center or a spiral point.
...
\begin{exercise}{23}
    ...
    23c. $\mathlarger{\frac{dr}{dt} = \frac{xx' + yy'}{r} = \frac{xy + \alpha x^2 r^2 - xy + \alpha y^2 r^2}{r} = \frac{\alpha r^2 (x^2 + y^2)}{r} = \alpha r^3}$.
